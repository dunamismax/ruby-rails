...
Gem::Specification.new do |spec|
  ...
  spec.summary = "CLI tool for organizing files"
  spec.description = "A command-line tool for organizing files by type, date, or custom rules"
  ...
  spec.bindir = "bin"
  spec.executables = ["file_organizer"]
